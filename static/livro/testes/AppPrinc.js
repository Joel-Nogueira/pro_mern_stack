...
var passouPeloConstrutor = false;
    ...
    _createClass(IssueFilter, [{
        ...
        value: function render() {
            return React.createElement(
                'div',
                null,
                'This placeholder for IssueFilter'
            );
        }
    }]);
...
var IssueAdd = function (_React$Component4) {
    ...
    _createClass(IssueAdd, [{
        ...
        value: function handleSubmit(e) {
            ...
            this.props.createChildIssue(issue);
...
var IssueList = function (_React$Component5) {
    ...
    function IssueList() {
        ...
        if (passouPeloConstrutor == false) {
            _this5.state = { issues: issues };
            passouPeloConstrutor = true;
        }

        console.log("Construtor: " + passouPeloConstrutor);
    ...
    _createClass(IssueList, [{
        ...
        key: 'escreveNoConsole',
        value: function escreveNoConsole() {
            console.log("FUNÇÃO DA CHILD!!!!");
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'button',
                    { onClick: this.escreveNoConsole },
                    'Adicionar'
                ),
                React.createElement('hr', null),
                React.createElement(IssueAdd, { action: this.escreveNoConsole })
            );
        }
    }]);
